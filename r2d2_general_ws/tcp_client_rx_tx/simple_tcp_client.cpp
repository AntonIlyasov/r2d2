...
#define MY_CLIENT_PORT 20002
#define MY_CLIENT_IP "127.0.0.1"

const uint8_t DATA_LEN = 101;
...
void sendMsg(ip::tcp::socket& socket) {
  ...
  uint8_t msg[101] = {158,94,41,203,16,199,241,63,158,94,41,203,16,199,241,63,
                      158,94,41,203,16,199,241,63,158,94,41,203,16,199,241,63,
                      158,94,41,203,16,199,241,63,158,94,41,203,16,199,241,63,
                      158,94,41,203,16,199,241,63,158,94,41,203,16,199,241,63,
                      158,94,41,203,16,199,241,63,158,94,41,203,16,199,241,63,
                      158,94,41,203,16,199,241,63,158,94,41,203,16,199,241,63,
                      1,kpl_bytes[3], kpl_bytes[2], kpl_bytes[1], kpl_bytes[0]};
  std::cout << "\nInput...\n";
