...
public:
  ...
  : socket_(io_service, udp::endpoint(udp::v4(), PORT)){
    toTofCamControlPub   = node.advertise<std_msgs::ByteMultiArray>(TO_TOF_CAM_CONTROL_TOPIC_NAME, 100);
    fromTofCamControlSub = node.subscribe<std_msgs::ByteMultiArray>(FROM_TOF_CAM_CONTROL_TOPIC_NAME, 100, 
        &UDPServer::from_tof_cam_control_callback, this, ros::TransportHints().tcp());

    memset(dataFromUDP, 100, sizeof(dataFromUDP));
    memset(dataToUDP, 100, sizeof(dataToUDP));
    memset(dataToTofCamControl, 100, sizeof(dataToTofCamControl));
    memset(dataFromTofCamControl, 100, sizeof(dataFromTofCamControl));
...
private:
  ...
  void from_tof_cam_control_callback(const std_msgs::ByteMultiArray::ConstPtr& recvdMsg){
    ...
    std::cout << "\n\033[1;36mRECVD FROM TOPIC fromTofCamControlTopic resvdBytesFromTofCamControl = \033[0m" 
  ...
  */
  ...
  void sendMsgToTofCamControl(){
    ...
    std::cout << "\033[1;36mSEND T0 toTofCamControlTopic: \033[0m";
